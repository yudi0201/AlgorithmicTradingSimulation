...
public class AlgoTradingStreamjit {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //StreamCompiler sc2 = new Compiler2StreamCompiler();
	...
	public static final class AlgoTradingBenchmark extends SuppliedBenchmark { 
        public static ArrayList<Stock_data> getSource(){
            ...
            try   
            {  
                BufferedReader br = new BufferedReader(new FileReader("C:/Users/yudis/Documents/university/Summer2021/streamjit/src/edu/mit/streamjit/test/apps/AAPL_2015_UNIX.csv")); 
                br.readLine(); 
